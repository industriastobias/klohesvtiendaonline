const products = [
  ...
  // Con stock primero, luego sin stock, ordenados de mayor a menor precio
  // ============================================
  
  // Carteras con stock (ordenadas mayor a menor precio)
  ...
  { name: "CARTERA", price: 13.50, stock: 1, barcode: "073", category: "Carteras" },
  ...
  // Carteras sin stock (ordenadas mayor a menor precio)
  ...
  { name: "CARTERA", price: 15.99, stock: 0, barcode: "149", category: "Carteras" },
  { name: "CARTERA", price: 15.99, stock: 0, barcode: "150", category: "Carteras" },
  ...
  { name: "CARTERA", price: 12.00, stock: 0, barcode: "094", category: "Carteras" },
  { name: "CARTERA", price: 12.00, stock: 0, barcode: "095", category: "Carteras" },
  { name: "CARTERA", price: 10.99, stock: 0, barcode: "049", category: "Carteras" },
  ...
  // ============================================
  // ARITOS Y ARETES (51 productos)
  // Con stock primero, luego sin stock, ordenados de mayor a menor precio
  // ============================================
  
  // Aritos con stock (ordenados mayor a menor precio)
  ...
  { name: "ARITOS", price: 8.50, stock: 1, barcode: "174", category: "Aritos", description: "Aritos de acero inoxidable con laminado de oro de 14K resistentes a salpicaduras de agua, waterproof" },
  ...
  { name: "ARITOS", price: 6.00, stock: 1, barcode: "028393992", category: "Aritos", description: "Aritos de acero inoxidable con laminado de oro de 14K resistentes a salpicaduras de agua, waterproof" },
  { name: "ARITOS", price: 6.00, stock: 1, barcode: "081", category: "Aritos", description: "Aritos de acero inoxidable con laminado de oro de 14K resistentes a salpicaduras de agua, waterproof" },
  ...
  // Aritos sin stock (ordenados mayor a menor precio)
  ...
  // ============================================
  // COLLARES (53 productos)
  // Con stock primero, luego sin stock, ordenados de mayor a menor precio
  // ============================================
  
  // Collares con stock (ordenados mayor a menor precio)
  ...
  { name: "COLLAR CLASICO", price: 12.00, stock: 2, barcode: "020", category: "Collares", description: "Collares de acero inoxidable con laminado en oro de 18K resistentes a salpicaduras waterproof" },
  ...
  // Collares sin stock (ordenados mayor a menor precio)
  ...
  // ============================================
  // PULSERAS (45 productos)
  // Con stock primero, luego sin stock, ordenados de mayor a menor precio
  // ============================================
  
  // Pulseras con stock (ordenadas mayor a menor precio)
  ...
  // Pulseras sin stock (ordenadas mayor a menor precio)
  { name: "PULSERA", price: 12.99, stock: 0, barcode: "105", category: "Pulseras" },
  ...
  { name: "PULSERA", price: 10.50, stock: 0, barcode: "02221", category: "Pulseras" },
  { name: "PULSERA", price: 5.50, stock: 0, barcode: "1250", category: "Pulseras" },
  
  // ============================================
  // RELOJES (33 productos)
  // Con stock primero, luego sin stock, ordenados de mayor a menor precio
  // ============================================
  
  // Relojes con stock (ordenados mayor a menor precio)
  ...
  // Relojes sin stock (ordenados mayor a menor precio)
  ...
  // Todos los anillos tienen stock 1 y mismo precio $10.00
