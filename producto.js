...
<body>
    ...
    <!-- MODAL DE STOCK INSUFICIENTE - NUEVO -->
...
function getProductMaterial(name, code, category) {
    ...
    return null;
        ...
        // NUEVO: Modal de stock insuficiente
        ...
        function addToCart(id) {
            ...
            if (existing) {
                if (existing.quantity + qty <= product.stock) {
                    ...
                    showStockModal(); // NUEVO: Mostrar modal en lugar de alert
                    return;
                }
            } else {
        ...
        function updateCartQty(id, change) {
            ...
            if (newQty <= 0) {
                ...
                showStockModal(); // NUEVO: Mostrar modal cuando no hay stock suficiente
            }
        }
